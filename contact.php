...
catch (Exception $e)
{
 ...
 if(isset($_POST['name_message']) && isset($_POST['mail_message']) && isset($_POST['text_message'])){
 		...
 		$texte = "Message de Madame/Monsieur ".$_POST['name_message']."\n"."\n".$_POST['text_message']."\n"."\n"."Voici l'adresse pour contacter la personne "."\n".$_POST['mail_message'];

 	if (mail("sunlightness123@gmail.com", "Reception d'un message", $texte)) {
...
<html lang="fr">
	...
	<body class="bodycontact">
		...
		<form method="post" action="contact.php">
			...
			<button type="submit" name="Envoyer" class="feedback">Envoyer</button><!--bouton d'envoi du formulaire-->
		</form>
